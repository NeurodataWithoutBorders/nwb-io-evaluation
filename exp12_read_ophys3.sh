...
#SBATCH --array=1-126
#SBATCH --job-name=exp12_read_ophys3
#SBATCH --output=/global/scratch/users/rly/nwbio/exp12/read_logs/ophys3--%A_%03a-out.log
#SBATCH --error=/global/scratch/users/rly/nwbio/exp12/read_logs/ophys3--%A_%03a-err.log
